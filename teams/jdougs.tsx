...
export default async function JDougs() {
  const api = new PokemonClient();
  let playerName = 'dtbaggins';
  let pok1 = await api.getPokemonByName('sableye-mega');
  let pok2 = await api.getPokemonByName('rotom-wash');
  let pok3 = await api.getPokemonByName('blissey');
  let pok4 = await api.getPokemonByName('togekiss');
  let pok5 = await api.getPokemonByName('chansey');
  let pok6 = await api.getPokemonByName('dragalge');
  let pok7 = await api.getPokemonByName('bronzong');
  let pok8 = await api.getPokemonByName('ditto');
  let pok9 = await api.getPokemonByName('shedinja');
  let pok0 = await api.getPokemonByName('shuckle');
