...
export default async function Dom() {
  ...
  let playerName = 'castleflutes';
  let pok1 = await api.getPokemonByName('kangaskhan-mega');
  let pok2 = await api.getPokemonByName('volcarona');
  let pok3 = await api.getPokemonByName('jirachi');
  let pok4 = await api.getPokemonByName('conkeldurr');
  let pok5 = await api.getPokemonByName('hippowdon');
  let pok6 = await api.getPokemonByName('tentacruel');
  let pok7 = await api.getPokemonByName('haxorus');
  let pok8 = await api.getPokemonByName('chandelure');
  let pok9 = await api.getPokemonByName('zangoose');
  let pok0 = await api.getPokemonByName('golem-alola');
