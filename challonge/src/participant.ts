...
export default class Participant extends ChallongeBase {
  ...
  public get(): Promise<Participant> {
    return new Promise((resolve, reject) => {
      ParticipantAdapter.show(this.api_key, this.baseUrl, this.id)
        .then((res) => {
  ...
  public update(
    ...
    return new Promise((resolve, reject) => {
      ParticipantAdapter.update(this.api_key, this.baseUrl, this.id, params)
        .then((res) => {
          Object.assign(this, res.participant);
          resolve(this);
        })
  ...
  public checkIn() {
    return new Promise((resolve, reject) => {
      ParticipantAdapter.checkIn(this.api_key, this.baseUrl, this.id)
        .then((res) => {
          Object.assign(this, res.participant);
          resolve(this);
        })
  ...
  public undoCheckIn() {
    return new Promise((resolve, reject) => {
      ParticipantAdapter.undoCheckIn(this.api_key, this.baseUrl, this.id)
        .then((res) => {
          Object.assign(this, res.participant);
          resolve(this);
        })
  ...
  public destroy() {
    return new Promise((resolve, reject) => {
      ParticipantAdapter.destroy(this.api_key, this.baseUrl, this.id)
        .then((res) => {
          if ((res.status = 200)) {
