...
export default class Match extends ChallongeBase {
  ...
  public get(): Promise<Match> {
    return new Promise((resolve, reject) => {
      MatchAdapter.show(this.api_key, this.baseUrl, this.id)
        .then((res) => {
  ...
  public update(
    params?: MatchInterfaces.matchUpdateRequestObject
  ): Promise<Match> {
    return new Promise((resolve, reject) => {
      MatchAdapter.update(this.api_key, this.baseUrl, this.id, {
        match: params,
      })
        .then((res) => {
          Object.assign(this, res.match);
  ...
  public reopen(): Promise<Match> {
    return new Promise((resolve, reject) => {
      MatchAdapter.reopen(this.api_key, this.baseUrl, this.id)
        .then((res) => {
          Object.assign(this, res.match);
          resolve(this);
        })
  ...
  public getAllAttachments(): Promise<Array<Attachment>> {
    return new Promise((resolve, reject) => {
      MatchAttachmentAdapter.index(this.api_key, this.baseUrl, this.id)
        .then((res) => {
  ...
  public createAttachment(
    ...
    return new Promise((resolve, reject) => {
      MatchAttachmentAdapter.create(this.api_key, this.baseUrl, this.id, {
